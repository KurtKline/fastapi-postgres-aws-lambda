...
@router.get("/points/player/{player}", response_model=List[schemas.PointEvent])
...
@router.get("/points/player/{player}/season/{season}", response_model=List[schemas.PointEvent])
