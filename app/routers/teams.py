...
@router.get("/points/team/{team}", response_model=List[schemas.PointEvent], summary='point logs for a team')
...
@router.get("/points/team/{team}/season/{season}", response_model=List[schemas.PointEvent], summary='point logs for a specific team and season combination')
